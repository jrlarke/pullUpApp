...
const OverFortyPullups = () => {
  return (
    <ScrollView height={"100vh"}>
    <Center column>
      <h2>More than 40 pull ups</h2>
      <Center column>
      <Table>
        <TableHeader>
          <TableRow>
        ...
        <TableBody>
          <TableRow>
            ...
            <TableRowColumn>24</TableRowColumn>
            <TableRowColumn>Max (Min 27)</TableRowColumn>
          </TableRow>
          <TableRow>
          ...
          <TableRowColumn>26</TableRowColumn>
          <TableRowColumn>26</TableRowColumn>
          <TableRowColumn>Max (Min 31)</TableRowColumn>
          </TableRow>
          <TableRow>
            <TableRowColumn>Minimum 1 day break</TableRowColumn>
            <TableRowColumn></TableRowColumn>
          ...
          <TableRowColumn>26</TableRowColumn>
          <TableRowColumn>26</TableRowColumn>
          <TableRowColumn>Max (Min 33)</TableRowColumn>
          </TableRow>
          <TableRow>
            <TableRowColumn>Minimum 1 day break</TableRowColumn>
            <TableRowColumn></TableRowColumn>
          ...
          <TableRowColumn>26</TableRowColumn>
          <TableRowColumn>26</TableRowColumn>
          <TableRowColumn>Max (Min 34)</TableRowColumn>
          </TableRow>
          <TableRow>
            <TableRowColumn>Minimum 1 day break</TableRowColumn>
            <TableRowColumn></TableRowColumn>
          ...
          <TableRowColumn>27</TableRowColumn>
          <TableRowColumn>27</TableRowColumn>
          <TableRowColumn>Max (Min 35)</TableRowColumn>
          </TableRow>
          <TableRow>
            <TableRowColumn>Minimum 2 day break</TableRowColumn>
            <TableRowColumn></TableRowColumn>
...
export default OverFortyPullups
